...
[установочный релиз](https://github.com/nevrozzkie/AutoVPN/releases/tag/router-v0.17.1-openwrt-25.12.5-r1):
...
У APK своя техническая версия (`0.17.1`); это компонент общего обновления AutoVPN 2.0.
