...
## О публикации исходного кода и роли автора

Этот GitHub-репозиторий содержит исходный код, тесты, сборочные материалы
и техническую документацию AutoVPN. Они доступны для изучения устройства
программы, разработки и самостоятельного развёртывания на своей инфраструктуре.
Описание возможностей проекта не является обещанием доступа к какому-либо
конкретному интернет-ресурсу или гарантией анонимности.

**Публикация репозитория не предоставляет подключение к VPN-серверу автора.**
Скачивание кода не выдаёт действующую подписку или учётные данные для такого
сервера. Для работы требуется отдельно настроенная инфраструктура; её владелец
выбирает серверы, пользователей и параметры подключения. Упоминание подписок
и клиентов в документации относится к функциям самостоятельно развёрнутой панели,
а не к продаже доступа через этот репозиторий.

Автор публикует программный код и описывает его работу, а не принимает на себя
администрирование каждой созданной на его основе установки. Авторство кода
и эксплуатация конкретного сервиса — разные роли; если автор сам управляет
отдельной установкой, этот раздел не исключает его обязанностей в этой роли.

Автор не призывает использовать проект для противоправных действий и не обещает
освобождения от ответственности за них. Документация предназначена для описания
технического устройства и обслуживания программы, а не для предложения совершать
правонарушения. Эти положения не изменяют фактические возможности программы
и не подменяют правовую оценку её распространения.

### Правовой статус публикации

Само размещение на GitHub, бесплатность кода и слова «не реклама» или
«в образовательных целях» не создают автоматического освобождения автора
от требований законодательства. При оценке публикации имеют значение её
содержание и обстоятельства распространения, а не только этот раздел.
Вопрос о признаках рекламы рассматривается с учётом
[статьи 3 Федерального закона № 38-ФЗ](https://base.garant.ru/12145525/5ac206a89ea76855804609cd950fcaf7/);
ответственность за рекламу соответствующих средств доступа предусмотрена
[частью 18 статьи 14.3 КоАП РФ](https://www.consultant.ru/document/cons_doc_LAW_511068/3d0cac60971a511280cbba229d9b6329c07731f7/).

Исключение для определённой научной, научно-технической и статистической
информации в критериях Роскомнадзора уточнено
[приказом от 17.10.2024 № 196](https://www.consultant.ru/document/cons_doc_LAW_491008/).
Этот README не заявляет, что весь репозиторий автоматически подпадает под него.
Для оценки правовых рисков автора требуется анализ всего опубликованного
комплекта, включая инструкции, исходники, изображения и описания релизов,
специалистом по применимому праву. Настоящий раздел не является юридическим
заключением о допустимости публикации и не отменяет установленную законом
ответственность автора за его собственные действия.
