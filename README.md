...
[установочный релиз](https://github.com/nevrozzkie/AutoVPN/releases/tag/router-v0.14.7-openwrt-25.12.5-r1):
...
У APK своя техническая версия (`0.14.7`); это компонент общего обновления AutoVPN 2.0.
...
Релиз содержит установщик, закреплённый manifest, три подписанных APK и исходники.
Это предварительный выпуск: установка на реальный роутер пока не проверена.
