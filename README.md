...
[установочный релиз](https://github.com/nevrozzkie/AutoVPN/releases/tag/router-v0.14.8-openwrt-25.12.5-r1):
...
У APK своя техническая версия (`0.14.8`); это компонент общего обновления AutoVPN 2.0.
