...
[установочный релиз](https://github.com/nevrozzkie/AutoVPN/releases/tag/router-v0.14.5-openwrt-25.12.5-r1):
...
У APK своя техническая версия (`0.14.5`); это компонент общего обновления AutoVPN 2.0.
