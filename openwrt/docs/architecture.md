...
Текущий пользовательский scope ограничен базовым Wi-Fi и VPN-сетью `-в`. Zapret-only
и VPN+zapret сети/контролы не активны в LuCI; упоминания zapret ниже относятся к
сохранённому legacy backend и не являются обещанием доступного runtime.
